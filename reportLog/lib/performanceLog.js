...
var _baseLog = _interopRequireDefault(require("./baseLog"));

var PerformanceLog = /*#__PURE__*/function (_BaseLog) {
  (0, _inheritsLoose2.default)(PerformanceLog, _BaseLog);
  ...
  _proto.report = function report() {
    var oData = (0, _extends2.default)({}, this._getBaseData(), {
      pData: (0, _extends2.default)({}, this.getPerformanceTiming(), {}, this.getPerformanceNavigation())
    });
    /* 如果配置了请求方法，直接返回请求方法 */
