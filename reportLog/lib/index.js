...
var PerformanceReport = /*#__PURE__*/function () {
  function PerformanceReport(props) {
    ...
    this.logApi = props.logApi;
    this.transParmas = props.transParmas;
    this.request = props.request;
    this._t = window.performance.timing;
    this._navigation = window.performance.navigation;
  }

  var _proto = PerformanceReport.prototype;

  _proto.report = function report() {
    var data = (0, _extends2.default)({}, this.getPerformanceTiming(), {}, this.getPerformanceNavigation());
    var newData = typeof this.transParmas === "function" ? this.transParmas(data) : data;
    /* 如果配置了请求方法，可以直接返回请求方法 */

    return typeof this.request === "function" ? this.request(newData) : newData;
  };
